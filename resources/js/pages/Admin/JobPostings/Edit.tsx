...
export default function Edit({ jobPosting, departments, employmentTypes }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        department_id: jobPosting.department_id ? String(jobPosting.department_id) : '',
        employment_type_id: jobPosting.employment_type_id ? String(jobPosting.employment_type_id) : '',
        title: jobPosting.title ?? '',
        description: jobPosting.description ?? '',
        number_of_positions: jobPosting.number_of_positions,
        status: jobPosting.status,
        opened_on: jobPosting.opened_on ?? '',
        closed_on: jobPosting.closed_on ?? '',
    });

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/job-postings/${jobPosting.id}`);
    };
