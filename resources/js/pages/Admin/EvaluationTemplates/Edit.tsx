...
export default function Edit({ evaluationTemplate }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/evaluation-templates/${evaluationTemplate.id}`);
    };

    return (
        <AppLayout>
            <Head title="評価テンプレート編集" />

            <div className="p-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">評価テンプレート編集</h1>
