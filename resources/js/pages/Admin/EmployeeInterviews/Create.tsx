...
export default function Create({ employee, employees }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(`/admin/employees/${employee.id}/interviews`);
    };
        ...
        <AppLayout>
            ...
            <div className="p-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">面談記録登録</h1>
                ...
                <form onSubmit={submit} className="mt-6 space-y-6 rounded-lg border p-6">
                    <div>
                        ...
                        />
                        {errors.interview_date && <div className="mt-1 text-sm text-red-600">{errors.interview_date}</div>}
                    </div>
