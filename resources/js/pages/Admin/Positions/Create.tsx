        ...
        <AppLayout>
            ...
            <div className="p-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">役職登録</h1>
                ...
                <form onSubmit={submit} className="mt-6 space-y-6 rounded-lg border p-6">
                    <div>
                        <label className="mb-2 block text-sm font-medium">役職名</label>
                        <input
                            type="text"
                            value={data.name}
                    ...
                    <div>
                        <label className="mb-2 block text-sm font-medium">管理職</label>
                        <select
                            value={data.is_manager ? '1' : '0'}
                            onChange={(e) => setData('is_manager', e.target.value === '1')}
                            className="w-full rounded-md border px-3 py-2"
                        >
                        ...
                        {errors.is_manager && (
                            <div className="mt-1 text-sm text-red-600">{errors.is_manager}</div>
                        )}
                    </div>
