...
export default function Edit({ evaluation, reviewer, employees }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        reviewer_employee_id: String(reviewer.reviewer_employee_id),
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/evaluations/${evaluation.id}/reviewers/${reviewer.id}`);
    };
        ...
        <AppLayout>
            ...
            <div className="p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">評価者編集</h1>
